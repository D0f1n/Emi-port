...
/**
 * A JEI fluid-configured slot ({@code setFluidRenderer}) rendered as an EMI tank. The original's
 * z-lift and blend toggles around the overlay are gone with the two-phase 26.2 context.
 */
