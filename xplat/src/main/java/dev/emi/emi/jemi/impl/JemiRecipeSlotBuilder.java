...
/** Records a JEI slot's position/decorations; the ingredient side delegates to the acceptor. */
public class JemiRecipeSlotBuilder implements IRecipeSlotBuilder {
	...
	public IRecipeSlotBuilder addRichTooltipCallback(IRecipeSlotRichTooltipCallback tooltipCallback) {
		this.richTooltipCallback = tooltipCallback;
		return this;
	}
	...
	// IIngredientAcceptor delegation
	...
	@Override
	public <I> IRecipeSlotBuilder add(IIngredientType<I> type, SlotDisplay display) {
		acceptor.add(type, display);
		return this;
	}
	...
	@Override
	public IRecipeSlotBuilder addItemStacks(List<ItemStack> stacks) {
