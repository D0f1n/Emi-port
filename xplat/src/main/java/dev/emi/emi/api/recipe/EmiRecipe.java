...
public interface EmiRecipe {
	 ...
	 *  By default, uses the result of {@link EmiRecipe#getId()} to look up the harvested server recipes.
	 *  Only available with a full recipe view (singleplayer, or a server with EMI installed).
	 */
